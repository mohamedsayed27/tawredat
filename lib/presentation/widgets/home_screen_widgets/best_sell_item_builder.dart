...
class BestSellWidget extends StatelessWidget {
  ...
  const BestSellWidget({Key? key, this.isDetails=false}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return InkWell(
      onTap: (){Navigator.pushNamed(context, ScreenName.productDetailsScreen);},
      child: Padding(
        padding: EdgeInsets.symmetric(vertical: 8.5.h),
        child: Container(
          padding: EdgeInsets.symmetric(horizontal: 15.h,vertical: 15.h),
          height: 149.h,
          width: isDetails?350.w:double.infinity,
